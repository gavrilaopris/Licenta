...
public class PopupDateChangerProject extends AppCompatDialogFragment {
    ...
    public static String userid, projectid, etapaid, endDate;
...
//        userid = getArguments().getString("userid");
    ...
    private void Update(String endDate, String projectid) {
