...
public class PopupDateChanger extends AppCompatDialogFragment {
    ...
    public static String userid, taskid, etapaid, endDate;
...
//        userid = getArguments().getString("userid");
    ...
    private void Update(String endDate, String taskid) {
