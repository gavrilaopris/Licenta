...
public class GanttTableAdapterTasks extends BaseTableAdapter {
    private static final String TAG = GanttTableAdapterTasks.class.getSimpleName();
    ...
    public GanttTableAdapterTasks(AppCompatActivity compatActivity, GanttData ganttData) {
        this.compatActivity = compatActivity;
        scale = compatActivity.getResources().getDisplayMetrics().density;
        dx = (int) (dx * scale);
        dy = (int) (dy * scale);

        this.etapa = ganttData.getEtapa();
        ...
        DateTime etapaStartDate = DateTime.parse(etapa.getStartDate(), DateTimeFormat.forPattern(AppConstant.DATE_FORMAT_yyyy_MM_dd));
        ...
        DateTime etapaEndDate = DateTime.parse(etapa.getEndDate(), DateTimeFormat.forPattern(AppConstant.DATE_FORMAT_yyyy_MM_dd));
