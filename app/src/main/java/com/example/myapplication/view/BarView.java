...
//        canvas.drawRect(shadowRect, shadow);
            ...
            int numOfChars = mCharTaskNamePaint.breakText(task.getTitlu(), true, rect.width(), null);
//        int start = (task.getTitle().length() - numOfChars) / 2;
            int start = 0;
            canvas.drawText(task.getTitlu(), start, start + numOfChars, rect.centerX(), rect.centerY() + 10, mCharTaskNamePaint);
